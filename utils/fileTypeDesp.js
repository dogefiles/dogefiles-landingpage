const  renderSwitch =(item)=> {
    ...
    switch (item.fileType) {
      ...
      case "jpg":
        return{
          short:"JPG is a widely used compressed image format for containing digital images.",
      ...
      case "jpeg":
        return{
          short:"JPEG is a widely used compressed image format for containing digital images.",
      ...
      case "exe":
        return{
          short:"exe is a common filename extension denoting an executable file for Microsoft Windows.",
      ...
      case "zip":
        return{
          short:"ZIP is an archive file format that supports lossless data compression.",
      ...
      case "csv":
        return{
          short:"A CSV is a comma-separated values file, which allows data to be saved in a tabular format.",
