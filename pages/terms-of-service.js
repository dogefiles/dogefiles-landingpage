  ...
  return (
    ...
    >
      <Box paddingLeft="2%">
        ...
        <Text>
          The Dogefiles website located at{" "}
          <Link
            href="https://dogefiles.com"
            target="_blank"
            rel="noreferrer noopener"
          >
            https://dogefiles.io
          </Link>{" "}
          is a copyrighted work belonging to Dogefiles. Certain features of the
        ...
        <Text>
          These Terms Of Service described the legally binding terms and
          conditions that oversee your use of the Site. BY LOGGING INTO THE
          SITE, YOU ARE BEING COMPLIANT THAT THESE TERMS and you represent that
          you have the authority and capacity to enter into these Terms. YOU
          SHOULD BE AT LEAST 18 YEARS OF AGE TO ACCESS THE SITE. IF YOU DISAGREE
          WITH ALL OF THE PROVISIONS OF THESE TERMS, DO NOT LOG INTO AND/OR USE
          THE SITE.
        </Text>
        ...
        <Text>
          ...
          make not guarantee that the site will meet your requirements, will be
        ...
        <Text>
          ...
          must be provided to our designated Copyright Agent: It is not possible
          for us to prevent the people from uploading copyright material with an
          automated software so that's why the copyright owners can contact us
          from the support and we will delete the file and suspend the user
          account.
        </Text>
        ...
        <Text paddingTop="1.5%">
          ...
          Notice to the Company should be sent to: India. After the Notice is
